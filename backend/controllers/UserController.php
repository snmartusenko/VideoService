...
//                'only' => ['login', 'logout', 'signup'],
                'rules' => [
                    ...
                    // блокировка админки от обычного пользовател€
                    [
                    ...
                    // блокировка админки от неизвестного посетител€
                    [
                        'actions' => ['logout', 'login', 'error'],
                        'allow' => true,
                        'roles' => ['?'],
...
//                    // дл€ зарегистрированного посетител€
//                    [
...
//                    ],
    ...
    public function actionUpdate($id)
    {
        ...
        /** * если пароль введен в форме -> устанавливаем пароль дл€ пользовател€
